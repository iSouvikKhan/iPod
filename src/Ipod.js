                ...
                <div id='inner-container' style={styles.wheel} onMouseOver={this.rotateWheel}>
                    ...
                    <div style={styles.buttonContainer}>
                        <div style={styles.middleButtons}>
                            ...
                            <div onClick={this.changePage} style={{ backgroundImage: 'linear-gradient(90deg, rgba(62,62,168,1) 99%, rgba(2,0,36,0) 100%)', width: '5rem', height: '5rem', borderRadius: '50%' }}></div>
...
const styles = {
    ipodContainer: {
        height: '36rem',
        width: '20rem',
        backgroundImage: 'linear-gradient(90deg, rgba(2,0,36,0) 0%, rgba(208,208,255,1) 0%, rgba(200,200,240,1) 100%)',
        margin: '4rem auto',
        display: 'flex',
        flexDirection: 'row',
        flexWrap: 'wrap',
        ...
        borderRadius: '24px',
        boxShadow: '-2px 3px 38px 5px rgba(0,0,0,0.75), inset 1px -5px 34px -2px rgba(0,0,0,0.75)'
